...
void main(){
  ...
  group('Now Playing TV', (){
    ...
    test('should return connection failure when the device is not connection to internet', () async{
      when(mockRemoteDataSource.getNowPlayingTv())
  ...
  group('Popular TV', (){
    ...
    test('shpuld return server failure when call to data source is unsuccessful', () async{
      when(mockRemoteDataSource.getPopularTv())
          .thenThrow(ServerException());
      final result = await repository.getPopularTv();
      verify(mockRemoteDataSource.getPopularTv());
  ...
  group('Search Tv', () {
    ...
    test('should return Connection Failure when device is not connect to the internet', () async{
      when(mockRemoteDataSource.searchTv(tQuery))
          .thenThrow(SocketException('Failed to connect to the network'));
      final result = await repository.searchTv(tQuery);
      verify(mockRemoteDataSource.searchTv(tQuery));
