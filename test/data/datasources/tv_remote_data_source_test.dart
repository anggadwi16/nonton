...
void main(){
  ...
  group('get Now Playing Tv', (){
    ...
    test('should return list of Tv Model when response code is 200', () async{
      when(mockHttpClient
        ...
        .thenAnswer((_) async => http.Response(readJson('dummy_data/tv_airing_today.json'), 200));
  ...
  group('get Popular Tv', (){
    final tTvList = TvResponse.fromJson(json.decode(readJson('dummy_data/tv_popular.json')))
        .tvList;
